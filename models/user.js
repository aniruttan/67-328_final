 ...
 * This model uses the Node.js MongoDB Driver.
  ...
  */
 var connection_string = 'mongodb://localhost:27017/hw_15';
 ...
 connection_string = "mongodb://user:user@ds041581.mlab.com:41581/hw_15_users"
...
exports.delete = function(collection, query, callback) {
  mongoDB.collection(collection).deleteOne(query,function(err, status) { 
      if (err) doError(err);
      var success = (status.result.n == 1 ? true : false);
      callback(success);
    });
